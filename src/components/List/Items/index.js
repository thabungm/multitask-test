...
import ItemCreationForm from "../../../custom/ItemCreationForm";
import Item from "../Item";

import { SOURCE_LIST_ID } from "../../../config";
import { LIST_RELATIONSHIPS, SOURCE_LIST_QUERY } from "../../source-props/list";
import SimpleAccordion from "../../../custom/ItemCreationForm/accordionItem";
    ...
    return (
      ...
      >
        {({ loading, error, data, refetchQueries }) => {
          ...
          let items = data.unitData.map((el) => flattenData(el));
